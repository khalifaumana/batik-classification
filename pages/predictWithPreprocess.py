...
def app():
    st.header("Image Classification for Batik using Image Preprocessing")
    ...
    if uploaded_file is not None:
        ...
        label_index = machine_classification(image, 'model/modelBatikClassification_v1.3_a62va54.h5')
